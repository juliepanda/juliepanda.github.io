...
CT.FlexCylinder = function(n, r, w)       {   this.init();
                                        this.addChild(new CT.Revolved(n, 8, function(t) {
                                            return [r, w * t];
                                                                                    ...
                                                                                    }; CT.FlexCylinder.prototype = new CT.Object;
CT.Wheel        = function(interval, r, w)   {
                                        this.init();
                                        this.addChild(new CT.Revolved(interval, 8, function(t) {
                                            return [r + (r/10), w * t];
                                        }));
                                        this.addChild(new CT.Revolved(interval, 8, function(t) {
                                            return [r, w * t];
                                        ...
                                        this.addChild(new CT.Disk(interval)).scale(r/10);
                                        this.addChild(new CT.Disk(interval)).translate(0, 0, w).scale(r/10);
                                        for (var i = 0; i < Math.round(interval/2); i++) {
                                            var barIndex = i - 5;
                                            var totalBars = Math.round(interval/2);
                                            this.addChild(new CT.Revolved(interval, 8, function(t) {
                                                return [r/80, 2 * r * t];
